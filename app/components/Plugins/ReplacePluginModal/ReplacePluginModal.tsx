  ...
  return (
    ...
    >
      <ModalActionIcons
        ...
        generatedUrl={replacedImageUrl}
      />

      {/* Simple replace button container with nodes */}
      <div
      ...
      >
        <ReplaceButton
          ...
          externalIsReplacing={externalIsReplacing}
              ...
              >
                {sourceImageUrl ? (
                  ...
                  >
                    ...
                    <p style={{ fontSize: '12px', marginTop: '8px' }}>Connect an image to the Replace plugin</p>
                  </div>
                )}
                <canvas
                  ref={canvasRef}
