  ...
  return (
    <div style={{ position: 'fixed', left: `${16 * s}px`, bottom: `${16 * s}px`, zIndex: 9999 }}>
      ...
      <style dangerouslySetInnerHTML={{
        __html: `
        .settings-btn { position: relative; overflow: hidden; }
        .settings-btn .hover-overlay { opacity: 0; transition: opacity 0.2s; pointer-events: none; position: absolute; top: 0; left: 0; width: 100%; height: 100%; }
        .settings-btn:hover .hover-overlay { opacity: 1; }
      `}} />
      <button
